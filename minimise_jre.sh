...
# Prepare locations
JAVA_VERSION="jre1.8.0_191"
ORIGINAL_JAR_FILE="${JAVA_VERSION}-${TARGET_PLATFORM}-x64.zip"
MINIMISED_JAR_FILE="${JAVA_VERSION}x${SCRIPT_VERSION}-${TARGET_PLATFORM}-x64-minimal.zip"
